...
public class ReportServiceImpl implements ReportService {
	...
	public ZPMajurPadereportWrapper getMajurPadeReport(Long userId) {
		...
		zPStaticDetailsService.loadManjurPade(user);
		Map<ZPBean, ZPManjurPade> manjurPade = zPStaticDetailsService.getManjurPade();
	...
	public Map<ZPDesAndCategoryBean, DataThreeInteger> loadFilledPade(User user) {
		List<DataThreeInteger> data = jdbcTemplate.query(
				"SELECT ee.employeeDesiganationId as val1, ed.employeeselectioncategory as val2, count(e.employee_id) as val3 FROM zpastapana_qa.employee e\r\n"
