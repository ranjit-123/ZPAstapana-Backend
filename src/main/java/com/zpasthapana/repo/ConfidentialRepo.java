...
public interface ConfidentialRepo extends JpaRepository<Confidential, Long>{
	...
	@Query(value = "select c from Confidential c inner join c.employee e inner join e.employeeWorkLocation w "
	...
	Page<Confidential> findAllByPermission(Long devisionId, Long zpId, Long departmentId, Long talukaId, Pageable paging);
