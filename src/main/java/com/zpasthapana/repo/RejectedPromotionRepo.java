...
public interface RejectedPromotionRepo extends JpaRepository<RejectedPromotion, Long>{

	@Query(value = "select r from RejectedPromotion r inner join r.employee e inner join e.employeeWorkLocation w "
