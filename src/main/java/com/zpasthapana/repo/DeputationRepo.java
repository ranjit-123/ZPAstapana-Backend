...
public interface DeputationRepo extends JpaRepository<Deputation, Long>{
	...
	@Query(value = "select e from Deputation d inner join d.employee e inner join e.employeeWorkLocation w "
	...
	Page<Deputation> findAllByPermission(Long devisionId, Long zpId, Long departmentId, Long talukaId, Pageable paging);
